(function (factory) {
  ...
  class VanillaTilt {
    constructor(element, settings = {}) {
      ...
      this.glarePrerender = this.settings["glare-prerender"];
    ...
    update() {
      ...
      this.element.style.transform =
        ...
        "px) " +
        "rotateX(" +
        (this.settings.axis === "y" ? 0 : values.tiltY) +
        "deg) " +
        "rotateY(" +
        (this.settings.axis === "x" ? 0 : values.tiltX) +
        "deg) " +
        "scale3d(" +
        this.settings.scale +
        ", " +
    ...
    addEventListeners() {
      this.onMouseEnterBind = this.handleMouseEnter.bind(this);
      this.onMouseMoveBind = this.handleMouseMove.bind(this);
      this.onMouseLeaveBind = this.handleMouseLeave.bind(this);
      this.onWindowResizeBind = this.handleWindowResize.bind(this);
  ...
  if (typeof document !== "undefined") {
     ...
     * Auto load
     */
    // Initialization is handled in script.js
  }
